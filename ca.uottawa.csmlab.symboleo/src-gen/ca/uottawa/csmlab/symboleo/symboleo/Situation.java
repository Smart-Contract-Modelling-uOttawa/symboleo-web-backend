 ...
 * </p>
 * <ul>
 *   <li>{@link ca.uottawa.csmlab.symboleo.symboleo.Situation#getStateName <em>State Name</em>}</li>
 * </ul>
 *
 * @see ca.uottawa.csmlab.symboleo.symboleo.SymboleoPackage#getSituation()
 * @model
 * @generated
 */
public interface Situation extends EObject
{
   ...
   * @see ca.uottawa.csmlab.symboleo.symboleo.SymboleoPackage#getSituation_StateName()
   * @model
   * @generated
   */
  String getStateName();
  ...
  /**
   * Sets the value of the '{@link ca.uottawa.csmlab.symboleo.symboleo.Situation#getStateName <em>State Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
