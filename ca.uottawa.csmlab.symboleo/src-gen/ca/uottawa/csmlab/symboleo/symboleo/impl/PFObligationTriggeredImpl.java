 ...
 * </p>
 * <ul>
 *   <li>{@link ca.uottawa.csmlab.symboleo.symboleo.impl.PFObligationTriggeredImpl#getNorm <em>Norm</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PFObligationTriggeredImpl extends PowerFunctionImpl implements PFObligationTriggered
{
  ...
  {
    return SymboleoPackage.Literals.PF_OBLIGATION_TRIGGERED;
  }
    ...
    if (norm != null && norm.eIsProxy())
    {
      ...
      if (norm != oldNorm)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SymboleoPackage.PF_OBLIGATION_TRIGGERED__NORM, oldNorm, norm));
      }
    }
    return norm;
  }
  ...
  public void setNorm(Obligation newNorm)
  {
    ...
    norm = newNorm;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SymboleoPackage.PF_OBLIGATION_TRIGGERED__NORM, oldNorm, norm));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SymboleoPackage.PF_OBLIGATION_TRIGGERED__NORM:
